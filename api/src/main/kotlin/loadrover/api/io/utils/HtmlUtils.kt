...
class HtmlUtils(
    ...
    fun reviseHtmlHeader(simulationId: String){
        ...
        val filePath = "${loadroverConfig.gatling.path}/${loadroverConfig.gatling.result}/${simulationId}/index.html"
        ...
        wrapperClass.html("<h1 class=\"gatling-logo gatling-logo-light\"><img alt=\"2bytes\" src=\"api/src/main/resources/static/h_logo_purple.svg\" style=\"width: 113%; height: auto;\"/></h1>\n<h1 class=\"gatling-logo gatling-logo-dark\"><img alt=\"2bytes\" src=\"api/src/main/resources/static/static/h_logo_white.svg\" style=\"width: 113%; height: auto;\"/></h1>")
        ...
        try {
            ...
            logger.error("Failed to revise result html: ${e.message.toString()}, simulationId: $simulationId")
        }
