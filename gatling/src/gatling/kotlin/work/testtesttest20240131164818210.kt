...
class testtesttest20240131164818210: Simulation() {
private val logger = LoggerFactory.getLogger(testtesttest20240131164818210::class.java)
...
override fun before() { logger.debug("-------------------------------------------- Scenario testtesttest20240131164818210 is about to start.------------------------------------------------------------------") }
override fun after() { logger.debug("-------------------------------------------- Scenario testtesttest20240131164818210 was completed.------------------------------------------------------------------") }
init {
var headers_0: Map<String, String> = mutableMapOf(
"accept" to "application/json, text/plain, */*",
"Content-Type" to "application/json"
)
val scn = scenario("testTesttest20240131164818210")
