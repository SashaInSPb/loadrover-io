...
class test44_accountTest20240130111218475: Simulation() {
...
val scn = scenario("test44_accountTest20240130111218475")
.exec(http("request_POST").post("/auth/authentication").headers(headers_0).body(StringBody("")).check(jsonPath("$.accessToken").saveAs("accessToken")))
.pause(1)
