...
class test20240202115107349: Simulation() {
private val logger = LoggerFactory.getLogger(test20240202115107349::class.java)
...
override fun before() { logger.debug("-------------------------------------------- Scenario test20240202115107349 is about to start.------------------------------------------------------------------") }
override fun after() { logger.debug("-------------------------------------------- Scenario test20240202115107349 was completed.------------------------------------------------------------------") }
init {
var headers_0: Map<String, String> = mutableMapOf(
"accept" to "application/json, text/plain, */*",
"Content-Type" to "application/json"
)
val scn0 = scenario("test20240202115107349-0")
...
.pause(0)
val scn1 = scenario("test20240202115107349-1")
